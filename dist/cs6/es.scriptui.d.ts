...
/**
 * The globally available Window class provides access to user notification tools
 * like Window.alert(), Window.confirm(), Windof.find() and Window.prompt().
 * 
...
/**
 * Controls the automatic layout behavior for a window or container. The subclass 
 * AutoLayoutManager implements the default automatic layout behavior. Create an 
 * instance of the AutoLayoutManager class with the new operator:
