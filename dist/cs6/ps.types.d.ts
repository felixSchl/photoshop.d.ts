...
interface Application {
     ...
     * an open document in the Adobe Photoshop CS6 application to bring it to
     * the front of the screen. Tip: If there is no open document, accessing
...
interface ArtLayer {
     ...
     * Adobe Photoshop CS6 Help for specific instructions.
     */
...
declare class BitmapConversionOptions {
     ...
     * valid patterns, see Adobe Photoshop CS6 Help on the bitmap conversion
...
interface Document {
     ...
     * Count Tool in the Adobe Photoshop CS6 Help
     */
...
declare class ExportOptionsSaveForWeb {
     ...
     * CS6’ on page 32. For references details of these classes, see the
...
interface Notifiers {
     ...
     * preferences folder. See Adobe Photoshop CS6 help for more information.
     */
    removeAll(): void
...
declare class PDFSaveOptions {
    ...
    /**
     * True to reopen the PDF in Adobe Photoshop CS6 with native Photoshop data
     * intact.
     */
...
interface Preferences {
    ...
    /**
     * True to retain Adobe Photoshop CS6 contents on the clipboard after you
    ...
    /**
     * The maximum percentage of available RAM used by Adobe Photoshop CS6 (5 -
     * 100).
     */
    maxRAMuse: number
    ...
    /**
     * True to enable Adobe Photoshop CS6 to send transparency information to
...
interface TextItem {
     ...
     * as Discretionary Ligatures. See Adobe Photoshop CS6 Help for more
     * information.
     */
